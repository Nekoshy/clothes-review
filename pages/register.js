                    ...
                    <div className={styles.rightSide}>
                        <div className="f-left w-65">
                            ...
                            <div className="f-right w-45">
                                ...
                                <input className={styles.input} placeholder="Podaj obwód pasa" name="waist_below" id="waist_below"/>
                        ...
                        <div className="f-right">
                            ...
                            <img id="menpic" src="mendim2.png" height="400px" className="d-none" alt='man'/>
                        </div>
                    </div>
